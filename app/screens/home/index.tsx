...
//   const buttons = [
//     { color: '#533BBF', name: 'Percurso', icon: require('../../components/icons/maneira.png') },
//     { color: '#1F73B3', name: 'Viagens', icon: require('../../components/icons/corrida.png') },
//     { color: '#2FB5B5', name: 'Classificação', icon: require('../../components/icons/avaliacao.png') },
//     { color: '#033C91', name: 'Avaliação', icon: require('../../components/icons/apresentacao.png') },
//   ];
